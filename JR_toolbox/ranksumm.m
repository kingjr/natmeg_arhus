function [Ustar p] = ranksumm(X,Y)
% compute multivariate centered ranksum test
...
% R language's own definition of the cross product ...
crossproduct = [R(1,:)*R(1,:)', R(1,:)*R(2,:)';R(2,:)*R(1,:)', R(2,:)*R(2,:)'];
%/!\ should be changed to get more than 2 dimnesions !
